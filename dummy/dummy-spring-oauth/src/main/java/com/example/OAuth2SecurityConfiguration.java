 ...
 */
@Configuration
@Import(OAuth2AuthorizationServerConfiguration.class) // Takes care of the /oauth2/entry_points
public class OAuth2SecurityConfiguration {
	...
	public JWKSource<SecurityContext> jwkSource() {
		...
		RSAKey rsaKey = new RSAKey.Builder(publicKey)
				...
				.build();
		JWKSet jwkSet = new JWKSet(rsaKey); // TODO: A list with 2 keys for backwards compatible update
		return new ImmutableJWKSet<>(jwkSet);
	}

	/**
	 * TODO: Key should come from Valut
	 */
